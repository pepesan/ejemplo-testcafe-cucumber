...
Feature: Contratación de un seguro de deportes
  ...
  Scenario: Rellenar seguro de sky de tres dias 2 adultos
    ...
    When user clicks modalPeople from seguros-page
    When user clicks plus60 from seguros-page
    When user clicks plus60 from seguros-page
    When user clicks validatePeople from seguros-page
    When user clicks boton3Dias from seguros-page
    When user clicks submitButton from seguros-page
